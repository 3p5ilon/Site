        ...
        {loading || !book ? (
          ...
          >
            <div className="relative flex items-start w-full p-2 sm:p-2.5 min-h-[5.5rem] sm:min-h-[7.75rem]">
              ...
              <div className="absolute top-3 right-3 w-7 h-7 rounded-full bg-[#E9E2D7] flex items-center justify-center shadow-sm flex-shrink-0">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-4 h-4 text-[#1E1914]"
                >
